...
## 操作系统课教学实验讲解视频
教学实验讲解视频的下载[链接](https://cloud.tsinghua.edu.cn/d/eec08e3c8f224e27b01d/)：

    1. ucore的五个实验的讲解
    2. rcore的五个实验的讲解
    3. ucore第五章的讲解

米明恒：rCore tutorial 实验入门指导[文字版本讲义](https://blog.ideawand.com/2022/11/18/rcore_tutorial/os-camp-2022-winter-riscv/)

## VScode调试插件
支持uCore和rCore内核源代码调试的[VScode调试插件工具code-debug使用帮助](https://osdebugger.github.io/docs/usage/)
